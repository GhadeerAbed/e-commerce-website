...
second_div: 'max-w-[510px] h-[550px] bg-white  sm:px-10 px-5  pt-8 my-10',
...
content_paragraph:'text-[#5c5c5c] font-[400]  sm:text-[14px] text-[12px]'
}
  ...
  return (
    <div className={styles.first_div}>
        <div className={styles.second_div}>
            ...
            <p className={styles.content_paragraph}>Already Have An Account ? <span className='font-[500] text-[#ff4141] cursor-pointer'>Login Here</span></p>
