const styles = {
  ...
  heading1: "font-poppins font-semibold xs:text-[58px] text-[50px]  xs:leading-[76.8px] leading-[66.8px] w-full",
...
export const layout = {
  ...
  sectionInfo: `flex-1 ${styles.flexStart} flex-col md:mt-0 mt-10`,
};
